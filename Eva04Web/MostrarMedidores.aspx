<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="MostrarMedidores.aspx.cs" Inherits="Eva04Web.MostrarMedidores" %>
            ...
            <ContentTemplate>
                <div class="row mt-5">
                    <asp:GridView 
                        ...
                        <Columns>
                            <asp:BoundField HeaderText="NumeroMedidor" DataField="NumeroMedidor" />
